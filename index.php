...
<div class="container">
    <h3 align="center">Tutorial <a href="javascript:void();">Carrito de Compra</a></h3>
    <?php
        ...
        <table class="table table-bordered">
            ...
            if(!empty($_SESSION["add_carro"]))
            {
                ...
                <tr>
                    ...
                    <td align="right">$ <?php echo number_format($total*0.12, 2); ?></td>

                    <td></td>
                </tr>
                <tr>
                    <td colspan="3" align="right">Total</td>
                    <td align="right">$ <?php echo number_format(($total*0.12)+$total, 2); ?></td>
                    <td></td>
                </tr>
                <tr>
                    <td colspan="3" align="right">Proceder Pago</td>
                    <td align="right"><a class="btn btn-success" href='datos.php'>Pagar</a></td>
                    <td></td>
                </tr>
                <?php
            }else{
